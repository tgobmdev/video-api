...
public class VideoCategoriaControllerImpl implements VideoCategoriaController {
  ...
  public VideoCategoriaControllerImpl(VideoCategoriaService videoCategoriaService) {
  ...
  public ResponseEntity<List<VideoResponse>> findByCategoriaEntitiesId(
    ...
    log.info("Requisição [GET] recebida em [/categorias/{}/videos]", idCategoria);
    List<VideoResponse> videoResponses = videoCategoriaService.findByCategoriaEntitiesId(
        idCategoria);
    log.info("Requisição [GET] finalizada em [/categorias/{}/videos]", idCategoria);
